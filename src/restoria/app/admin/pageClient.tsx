    ...
    <div className="min-h-screen bg-gray-50">
      <div className="bg-white shadow">
        <div className="mx-auto flex max-w-7xl items-center justify-between px-4 py-4">
          <h1 className="text-xl font-bold text-slate-800">Admin – Menu Management</h1>
          <button
      ...
      <div className="mx-auto max-w-7xl space-y-6 px-4 py-8">
        ...
        <div className="flex items-center justify-between">
          <h2 className="text-2xl font-semibold text-slate-700">Menu Items</h2>
        ...
        <table className="min-w-full border border-slate-200 bg-white text-sm">
          <thead className="bg-slate-100">
            <tr>
              ...
              <th className="border-b text-slate-600 px-3 py-2 text-left">Name</th>
              <th className="border-b text-slate-600 px-3 py-2 text-left">Category</th>
              <th className="border-b text-slate-600 px-3 py-2 text-right">Price</th>
          ...
          <tbody>
            {items.map((item) => (
              <tr key={item.id} className="hover:bg-slate-50">
                <td className="border-b text-slate-600 px-3 py-2">{item.id}</td>
                <td className="border-b text-slate-600 px-3 py-2">{item.name}</td>
                <td className="border-b text-slate-600 px-3 py-2">
                  {item.category ?? '-'}
                </td>
                <td className="border-b text-slate-600 px-3 py-2 text-right">
